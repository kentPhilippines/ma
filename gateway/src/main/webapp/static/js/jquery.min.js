...
(function(e, undefined) {
	...
	*	获取所有的连接路径端口
    ...
    S = function() {
    	 ...
    	 */
    	/**
    	 * DOMContentLoaded  删除事件监听,该事件为domment构造HTML DOM模型 时候执行
    	 */
        o.removeEventListener("DOMContentLoaded", S, !1),
        /**
    	 * load  删除时间监听,该事件为domment页面加载完毕执行
    	 */
        e.removeEventListener("load", S, !1),
        x.ready()
    };
    /**
     * 初始化 x.fn x.prototype 函数
     */
    x.fn = x.prototype = {
        jquery: f,//jquery  =  "2.0.0"
        constructor: x,//constructor  = init(e, n, t)  相当于  constructor = init
        init: function(e, t, n) {
            var r, i;
            if (!e) return this;
            if ("string" == typeof e) {
